...
<section class="mt-180 pb-36 border-b border-rich-purple-300/20 dark:border-rich-purple-300/10">
	<h1>Work</h1>
</section>

<div class="grid md:grid-cols-2">
	<div class="md:sticky top-160 self-start">
		<section id="current">
			<h2 class="purple-text">Current</h2>
			<ProjectSummary title="WordPress engineer" subtitle="Infinum" timeframe="from January 2021">
				I create custom WordPress block-based themes using Eightshift boilerplate. Main techologies
				used are React, PHP, HTML/CSS/JavaScript.
			</ProjectSummary>

			<div class="flex flex-col space-y-20">
				<p class="font-sans text-gray-500 w-max font-medium text-14">Shortcuts</p>
				<ArrowButton content='Student jobs' url='#student-jobs' arrowDirection={ArrowDirections.RIGHT} />
				<ArrowButton content='Internships' url='#internships' arrowDirection={ArrowDirections.RIGHT} />
				<ArrowButton content='Freelancing' url='#freelancing' arrowDirection={ArrowDirections.RIGHT} />
				<ArrowButton content='During my studies' url='#during-my-studies' arrowDirection={ArrowDirections.RIGHT} />
				<ArrowButton content='Personal projects' url='#personal-projects' arrowDirection={ArrowDirections.RIGHT} />
			</div>
		</section>
	...
	<div>
		...
		<section id="internships">
			...
			>
				I was a part of a team that worked on a company's project, used C# and SQL, learned a lot
		...
		<section id="freelancing">
			...
			>
				I designed a logo system for the agency, then set up a WordPress website, customized it,
				added custom content and did some basic SEO.
			</ProjectSummary>
			<ProjectSummary title="Promo materials" subtitle="Temple Bar" timeframe="March 2016 -">
				<span
					>I design promotional material for Facebook and Instagram ads for <i>Temple Bar</i> in Stubičke
					toplice.</span
				>
		...
		<section id="during-my-studies">
			...
			>
				<span
					>I was a part of the faculty magazine <i>St@k</i>. Started as a desginer, later lead the
					design team for a while (and still designed).</span
				>
				<span
					>Working in and leading a team helped me improve my teamwork and leadership skills.</span
				>
				<span
					>Magazine design was done in Adobe InDesign, together with Adobe Photoshop and Adobe
					Illustrator for supporting materials. Adobe Xd was used for some promotional materials.</span
				>
			</ProjectSummary>
			<div class="flex flex-col gap-30">
				...
				>
					I was a part of the Faculty of organization and informatics' Student council, where I
				...
				<ProjectSummary subtitle="Mladi pomažu" timeframe="December 2018">
					I created a logo and promotional materials for the student humanitarian action Mladi
					pomažu.
				</ProjectSummary>
				<ProjectSummary subtitle="Brucošijada grada Varaždina 2018" timeframe="October 2018">
					<span
						>I designed a logo, all the promotional materials and accrediations for the annual
						student welcoming party - <i>Brucošijada</i>.</span
					>
				</ProjectSummary>
				<ProjectSummary
					subtitle="Faculty of organization and informatics"
				...
				>
					I created promotional materials, t-shirt and banner designs for the Faculty of
					organization and informatics at STEM Games 2018 & 2019.
				</ProjectSummary>
			</div>
		</section>
		...
		<section id="personal-projects">
			...
			>
				A simple tool that can optimize and prepare your SVGs for use in Gutenberg or the site
				itself.
			</ProjectSummary>
			<ProjectSummary
