...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-7e59cca9.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-7e59cca9.js", "/./_app/chunks/vendor-69ce0b92.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-bc513ce6.js", "css": ["/./_app/assets/pages/__layout.svelte-5dbe59cd.css"], "js": ["/./_app/pages/__layout.svelte-bc513ce6.js", "/./_app/chunks/vendor-69ce0b92.js", "/./_app/chunks/stores-687d2ad9.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-51269cd6.js", "css": [], "js": ["/./_app/error.svelte-51269cd6.js", "/./_app/chunks/vendor-69ce0b92.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-8080919b.js", "css": ["/./_app/assets/pages/index.svelte-e248a3dd.css"], "js": ["/./_app/pages/index.svelte-8080919b.js", "/./_app/chunks/vendor-69ce0b92.js", "/./_app/chunks/stores-687d2ad9.js"], "styles": [] }, "src/routes/work/index.svelte": { "entry": "/./_app/pages/work/index.svelte-99cd79e0.js", "css": [], "js": ["/./_app/pages/work/index.svelte-99cd79e0.js", "/./_app/chunks/vendor-69ce0b92.js"], "styles": [] } };
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="${"h-80 sm:h-100 flex items-center px-30 sm:px-48 fixed top-0 left-0 right-0 bg-white bg-opacity-90 dark:bg-rich-purple-900 dark:bg-opacity-90 backdrop-blur-lg z-10"}"><nav class="${"contained w-full xl:px-48 flex items-center justify-between svelte-o0tdjv"}"><ul class="${"flex items-center gap-30 text-16 w-full"}">${validate_component(MenuButton, "MenuButton").$$render($$result, { isMenuOpen: isOpen, extraClass: "z-30" }, {}, {})}

			<li class="${"visible logo mr-auto sm:mr-0 z-20 sm:z-auto svelte-o0tdjv"}"><a sveltekit:prefetch href="${"/"}" aria-label="${"Go to homepage"}" class="${"svelte-o0tdjv"}">${validate_component(Logo, "Logo").$$render($$result, { color: true }, {}, {})}</a></li>

			${``}

			<div class="${[
    "fixed top-80 left-0 w-full max-w-xs sm:static flex flex-col sm:flex-row gap-30 bg-rich-purple-500 dark:bg-rich-purple-300 sm:bg-transparent sm:dark:bg-transparent p-30 sm:p-0 sm:w-max transition transform-gpu -translate-x-full sm:translate-x-0 rounded-br-xl sm:rounded-br-none rounded-tr-xl sm:rounded-tr-none shadow-2xl sm:shadow-none z-20 sm:z-auto svelte-o0tdjv",
    ""
  ].join(" ").trim()}"><li class="${["svelte-o0tdjv", $page.path === "/#about" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/#about"}" class="${"svelte-o0tdjv"}">About me</a></li>

				${$page.path === "/" ? `<li class="${["svelte-o0tdjv", $page.path === "/#work" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"#work"}" class="${"svelte-o0tdjv"}">Work</a></li>` : `<li class="${["svelte-o0tdjv", $page.path.startsWith("/work") ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/work"}" class="${"svelte-o0tdjv"}">Work</a></li>`}

				<li class="${"svelte-o0tdjv"}"><a sveltekit:prefetch href="${"/#contact"}" class="${"svelte-o0tdjv"}">Contact</a></li>
				<li class="${"svelte-o0tdjv"}"><a rel="${"external"}" sveltekit:prefetch href="${"/Goran-Alkovic-CV.pdf"}" class="${"svelte-o0tdjv"}">CV</a></li></div>

			${validate_component(ThemePicker, "ThemePicker").$$render($$result, { extraClass: "sm:ml-auto z-20 sm:z-auto" }, {}, {})}</ul></nav>
</header>`;
});
